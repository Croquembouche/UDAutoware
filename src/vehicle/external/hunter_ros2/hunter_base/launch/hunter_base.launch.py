...
def generate_launch_description():
    ...
    odom_frame_arg = DeclareLaunchArgument('odom_frame', default_value='base_link',
                                           description='Odometry frame id')
    base_link_frame_arg = DeclareLaunchArgument('base_frame', default_value='base_link',
                                                description='Base link frame id')
    odom_topic_arg = DeclareLaunchArgument('odom_topic_name', default_value='/sensing/vehicle_velocity_converter/twist_with_covariance',
