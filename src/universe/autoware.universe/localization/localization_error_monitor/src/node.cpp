...
: Node("localization_error_monitor"), updater_(this)
{
  ...
  warn_ellipse_size_ = this->declare_parameter("warn_ellipse_size", 80); // this was 0.8

  error_ellipse_size_lateral_direction_ =
    this->declare_parameter("error_ellipse_size_lateral_direction", 30); // this was 0.3
  warn_ellipse_size_lateral_direction_ =
    this->declare_parameter("warn_ellipse_size_lateral_direction", 20); // this was 0.2
  ...
  diagnostic_updater::DiagnosticStatusWrapper & stat)
{
  ...
  if (warn_ellipse_size_ <= ellipse_.long_radius) {
    ...
    RCLCPP_ERROR(
      get_logger(), "Comparing ellipse size: Threshold: %f ---- actual: %f",
      warn_ellipse_size_, ellipse_.long_radius);
  }
