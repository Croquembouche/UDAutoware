...
{
  // std::cout << "inside the ekf timer callback function" << std::endl;
  if (!is_activated_) {
...
void EKFLocalizer::publishEstimateResult()
{
  ...
  /* publish latest pose */
  // std::cout << "publishing biased pose with cov." << std::endl;
  ...
  // std::cout << "Publishing EKF Odom msg." << std::endl;
